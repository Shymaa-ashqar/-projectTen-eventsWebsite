                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">categories form</div>
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{route('categories.update',$category->id)}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Enter name"  value="{{$category->name}}">
                                            </div>
                                            <div>
